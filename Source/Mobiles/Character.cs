...
namespace Server
{
 ...
 WEAPONMODE_RANGEDMODE            =0x2,*/
        ...
        new public Item FindItemById(int id)
        {
            foreach (Item i in Items)
                if (i != null && i.Id == id)
                    return i;
	...
	*/
		...
		*/
        ...
        public void MeetingStoneInfo()
        {
            ...
            Converter.ToBytes(0, tempBuff, ref offset);
            Converter.ToBytes(0, tempBuff, ref offset);
            this.Send(OpCodes.SMSG_MEETINGSTONE_SETQUEUE, tempBuff, offset);
        }
		...
		*/
        ...
        public void ManagePacket(int code, byte[] data, ref int after, int len)
        {
            switch (code)
            {
                ...
                case (int)OpCodes.MSG_MOVE_START_BACKWARD:
                case (int)OpCodes.MSG_MOVE_SET_FACING:
                case (int)OpCodes.MSG_MOVE_STOP:
                case (int)OpCodes.MSG_MOVE_START_STRAFE_LEFT:
                case (int)OpCodes.MSG_MOVE_START_STRAFE_RIGHT:
                case (int)OpCodes.MSG_MOVE_STOP_STRAFE:
                case (int)OpCodes.MSG_MOVE_START_TURN_LEFT:
                case (int)OpCodes.MSG_MOVE_START_TURN_RIGHT:
                case (int)OpCodes.MSG_MOVE_STOP_TURN:
                case (int)OpCodes.MSG_MOVE_START_PITCH_UP:
                case (int)OpCodes.MSG_MOVE_START_PITCH_DOWN:
                case (int)OpCodes.MSG_MOVE_STOP_PITCH:
                case (int)OpCodes.MSG_MOVE_SET_RUN_MODE:
                case (int)OpCodes.MSG_MOVE_SET_WALK_MODE:
                case (int)OpCodes.MSG_MOVE_SET_PITCH:
                case (int)OpCodes.MSG_MOVE_START_SWIM:
                ...
                case (int)OpCodes.CMSG_TOGGLE_PVP:
                    {
                        break;
                    }
                ...
                case (int)OpCodes.CMSG_GAMEOBJECT_QUERY:
                    ...
                    break;
                case (int)OpCodes.CMSG_SET_TARGET_OBSOLETE:
                ...
                case (int)OpCodes.CMSG_LEAVE_CHANNEL:
                    ...
                    break;
                case (int)OpCodes.SMSG_MEETINGSTONE_SETQUEUE:
                    MeetingStoneInfo();
                    break;
