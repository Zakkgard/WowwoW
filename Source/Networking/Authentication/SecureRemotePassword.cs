    ...
    public partial class SecureRemotePassword
    {
        ...
        public BigInteger PublicEphemeralValueA
        {
            ...
            set
            {
                ...
                m_publicEphemeralValueA = new BigInteger(value.GetBytesBE());
        ...
        {
            get { return new BigInteger(Hash(PublicEphemeralValueA, PublicEphemeralValueB)); }
        }
        ...
        public static void Test()
        {
            ...
            BigInteger credentials = HashUtilities.HashToBigInteger(SRPParameters.Hash, "ADMIN:CHANGEME");

            var server = new SecureRemotePassword("ADMIN", credentials, true, SRPParameters.Defaults);
            var client = new SecureRemotePassword("ADMIN", credentials, false, SRPParameters.Defaults);
            ...
            client.PublicEphemeralValueB = server.PublicEphemeralValueB;
                ...
                Console.WriteLine("a = {0}", client.m_secretEphemeralValueA.ToHexString());
                Console.WriteLine("b = {0}", server.m_secretEphemeralValueB.ToHexString());
