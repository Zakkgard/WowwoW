...
namespace Server.Scripts.Commands
{
	public class PropsChecker
	{
		...
		public PropsChecker()
		{
			m_CmdEntries = new Hashtable( StringComparer.Default, CaseInsensitiveComparer.Default );
            m_ValueEntries = new Hashtable(StringComparer.Default, CaseInsensitiveComparer.Default);
		}
