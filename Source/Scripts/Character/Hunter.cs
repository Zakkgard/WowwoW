	...
	public class Hunter 
	{
		...
		public static void Start(Character c) 
		{
			...
			{ // Dwarf specific.
				...
				c.Equip(new RuggedTrappersShirt(), Slots.Shirt);
				c.Equip(new RuggedTrappersPants(), Slots.Legs);
				c.Equip(new RuggedTrappersBoots(), Slots.Feet);
				c.Equip(new WornAxe(), Slots.MainHand);
				c.Equip(new OldBlunderbuss(), Slots.Ranged);
